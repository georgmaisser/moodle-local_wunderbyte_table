...
$string['cachesecret'] = 'Cache security secret';
$string['cachesecret_desc'] = 'Secret key used for HMAC-based cache validation. Leave empty to use system password salt. Changing this will invalidate all existing cached tables.';
...
$string['enableclasswhitelist'] = 'Enable class whitelist validation (recommended)';
$string['enableclasswhitelist_desc'] = 'Security feature: Only allow whitelisted table classes to be deserialized from cache. Disable only if you experience compatibility issues with custom table subclasses. Keeping this enabled protects against object injection attacks.';
...
$string['filteridentifierconflict'] = 'A filter with the same identifier already exists. Please choose a different name or edit the existing filter.';
...
$string['cacheuseridmismatch'] = 'Security error: Cache entry belongs to a different user';
$string['cacheobjectnotfound'] = 'Cache object not found or expired';
$string['classnotwhitelisted'] = 'Security error: Class {$a} is not whitelisted for deserialization';
$string['invalidcachehash'] = 'Invalid cache hash format';
$string['invalidcachemetadata'] = 'Invalid or missing cache metadata';
$string['invalidcachedobject'] = 'Cached object is not a valid Wunderbyte Table instance';
$string['invalidsesskey'] = 'Invalid session key - please refresh the page';
$string['invalidsignature'] = 'Security error: Cache signature validation failed';
