...
$string['cachesecret'] = 'Cache-Sicherheitsschlüssel';
$string['cachesecret_desc'] = 'Geheimer Schlüssel für HMAC-basierte Cache-Validierung. Leer lassen, um das System-Passwort-Salt zu verwenden. Eine Änderung dieses Wertes invalidiert alle bestehenden gecachten Tabellen.';
...
$string['enableclasswhitelist'] = 'Klassen-Whitelist-Validierung aktivieren (empfohlen)';
$string['enableclasswhitelist_desc'] = 'Sicherheitsfunktion: Nur gelistete Tabellenklassen dürfen aus dem Cache deserialisiert werden. Deaktivieren Sie dies nur bei Kompatibilitätsproblemen mit benutzerdefinierten Tabellenklassen. Aktiviert lassen schützt vor Object-Injection-Angriffen.';
...
$string['filteridentifierconflict'] = 'Ein Filter mit derselben Kennung existiert bereits. Bitte wählen Sie einen anderen Namen oder bearbeiten Sie den bestehenden Filter.';
...
// Sicherheitsbezogene Fehlermeldungen.
$string['cacheuseridmismatch'] = 'Sicherheitsfehler: Cache-Eintrag gehört zu einem anderen Benutzer';
$string['cacheobjectnotfound'] = 'Cache-Objekt nicht gefunden oder abgelaufen';
$string['classnotwhitelisted'] = 'Sicherheitsfehler: Klasse {$a} ist nicht für Deserialisierung zugelassen';
$string['invalidcachehash'] = 'Ungültiges Cache-Hash-Format';
$string['invalidcachemetadata'] = 'Ungültige oder fehlende Cache-Metadaten';
$string['invalidcachedobject'] = 'Gecachtes Objekt ist keine gültige Wunderbyte-Table-Instanz';
$string['invalidsesskey'] = 'Ungültiger Session-Schlüssel - bitte Seite neu laden';
$string['invalidsignature'] = 'Sicherheitsfehler: Cache-Signaturvalidierung fehlgeschlagen';
